...
An LLM-based application that summarizes financial news and integrates with paper trading.
...
- **LLM:** OpenAI's GPT-4o-mini API for cost-effective and fast summarization.

### Application Flow

1. Obtain news from APIs/SEC feeds
